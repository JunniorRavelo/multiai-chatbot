		...
		wp_localize_script(
			...
			array(
				...
				'i18n'           => array(
					...
					'openLabel'     => __( 'Open chat', MULTCH_TEXT_DOMAIN ),
					'closeLabel'    => __( 'Close chat', MULTCH_TEXT_DOMAIN ),
					'resetLabel'    => __( 'Reset chat', MULTCH_TEXT_DOMAIN ),
					'minimizeLabel' => __( 'Minimize chat', MULTCH_TEXT_DOMAIN ),
					'onlineLabel'   => __( 'System online', MULTCH_TEXT_DOMAIN ),
					'thinking'      => __( 'Thinking…', MULTCH_TEXT_DOMAIN ),
					'welcomeLabel'  => __( 'Welcome message', MULTCH_TEXT_DOMAIN ),
					'errorGeneric'  => __( 'Could not send the message. Please try again.', MULTCH_TEXT_DOMAIN ),
				),
			)
		);
